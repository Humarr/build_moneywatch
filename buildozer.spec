...
# (str) Package name
package.name = moneywatcher

# (str) Package domain (needed for android/ios packaging)
package.domain = com.moneywatch
...
requirements = python3, kivy==master, https://github.com/kivymd/KivyMD/archive/master.zip, sqlite3, simplejson, premailer, cssselect, cachetools, lxml==4.9.2, certifi, charset_normalizer, yagmail, cssutils, chardet, requests, idna, gcloud, googleapis-common-protos, protobuf, httplib2, pyparsing, oauth2client, pyasn1, pyasn1-modules, rsa, six, pycryptodome, python-jwt,jwcrypto, cryptography==40.0.0, cffi==1.15.0, deprecated, wrapt, requests-toolbelt==0.10.1 ,chardet, asynckivy, asyncgui, plyer
#  python-for-android==2023.2.10
# pyjnius==1.4.2, cffi==1.15.0
# ,yagmail,premailer,cssutils,lxml

#  python-for-android,appdirs,colorama,jinja2,MarkupSafe,pep517,zipp,sh,toml,six,pytoml,importlib-metadata,
...
# services = Moneywatcher:service.py
...
android.presplash_color = #556b2f
# android.presplash_color = #492b7c
