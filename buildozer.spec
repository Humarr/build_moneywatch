...
requirements = python3.10.5, kivy==master, https://github.com/kivymd/KivyMD/archive/master.zip, sqlite3, simplejson, premailer, cssselect, cachetools, lxml,jnius,sh,colorama,jinja2,MarkupSafe,zipp,pytoml, certifi, charset_normalizer, yagmail, cssutils, chardet, requests, idna, gcloud, googleapis-common-protos, protobuf, httplib2, pyparsing, oauth2client, pyasn1, pyasn1-modules, rsa, six, pycryptodome, python-jwt,jwcrypto, cryptography, cffi, deprecated, wrapt, requests-toolbelt==0.10.1 ,chardet, asynckivy, asyncgui, plyer
