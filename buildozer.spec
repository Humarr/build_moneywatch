...
requirements = python3,kivy, kivymd, sqlite3, simplejson, premailer, cssselect, cachetools, lxml, certifi, charset_normalizer, yagmail, cssutils, chardet, requests, idna, gcloud, googleapis-common-protos, protobuf, httplib2, pyparsing, oauth2client, pyasn1, pyasn1-modules, rsa, six, pycryptodome, python-jwt,jwcrypto, cryptography, cffi, deprecated, wrapt, requests-toolbelt==0.10.1 ,chardet, asynckivy, asyncgui, https://github.com/kivy/plyer/archive/refs/heads/master.zip,jwt,python-for-android,jnius,sh,colorama,jinja2,MarkupSafe,zipp,pytoml,openssl
